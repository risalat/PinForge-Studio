...
export function resolveRuntimeTemplateTokens(
  ...
  return {
    ...
    fonts: {
      ...
      "font.book-serif": {
        fontFamily: "var(--font-literaturnaya), var(--font-lora), Georgia, serif",
        fontWeight: 400,
        letterSpacing: "0em",
        lineHeight: 1.1,
      },
      ...
      "font.bold-sans": {
        fontFamily: "var(--font-league-spartan), var(--font-poppins), sans-serif",
        fontWeight: 800,
        letterSpacing: "-0.03em",
        lineHeight: 0.96,
      },
      ...
      "font.script": {
        fontFamily: "var(--font-satisfy), var(--font-segoe-script), cursive",
        fontWeight: 400,
        letterSpacing: "0.01em",
        lineHeight: 1.08,
      },
      "font.signature": {
        fontFamily: "var(--font-parisienne), var(--font-segoe-script), cursive",
        fontWeight: 400,
        letterSpacing: "0.01em",
        lineHeight: 1.08,
      },
