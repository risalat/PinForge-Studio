...
> = {
  ...
  "scarlet-vanilla": {
    id: "scarlet-vanilla",
    label: "Scarlet Vanilla",
    description: "Scarlet red with vanilla cream and warm brown contrast for bright festive recipe covers.",
    palette: {
      canvas: "#f1e3db",
      band: "#fff9f1",
      footer: "#c02e31",
    ...
    supportingColors: ["#db5a3a", "#d8a032", "#3f7f5a"],
    typography: {
      title: {
        fontFamily: FONT_STACKS.editorial,
        fontWeight: 700,
    ...
    recommendationTags: ["food", "scarlet", "holiday", "bright", "festive"],
  },
  "crimson-custard": {
    id: "crimson-custard",
    label: "Crimson Custard",
    description: "Crimson orange-red paired with custard cream for bold dessert and dinner roundups.",
    palette: {
      canvas: "#f2e2d7",
      band: "#f9f7dc",
      footer: "#c43c1e",
    ...
    supportingColors: ["#e25c27", "#d8aa35", "#4f8b67"],
    typography: {
      title: {
        fontFamily: FONT_STACKS.editorial,
        fontWeight: 700,
    ...
    recommendationTags: ["food", "crimson", "dessert", "warm", "holiday"],
  },
  "ember-clementine": {
    id: "ember-clementine",
    label: "Ember Clementine",
    description: "Hot ember orange-red with creamy contrast for loud feed-first food templates.",
    palette: {
      canvas: "#f5e0d5",
      band: "#fff1e8",
      footer: "#e84e12",
    ...
    supportingColors: ["#ff6c2d", "#ffb13a", "#2f9c6a"],
    typography: {
      title: {
        fontFamily: FONT_STACKS.editorial,
        fontWeight: 700,
    ...
    recommendationTags: ["food", "ember", "bright", "citrus", "loud"],
  },
  "garnet-biscuit": {
    id: "garnet-biscuit",
    label: "Garnet Biscuit",
    description: "Deep garnet red with biscuit cream and amber warmth for rich savory or holiday covers.",
    palette: {
      canvas: "#ead9d3",
      band: "#fff2ea",
      footer: "#a42617",
    ...
    supportingColors: ["#c74322", "#ce8d36", "#4d8a66"],
    typography: {
      title: {
        fontFamily: FONT_STACKS.editorial,
        fontWeight: 700,
    ...
    recommendationTags: ["food", "garnet", "savory", "holiday", "rich"],
  },
};
...
> = {
  ...
  "plum-fig": "food-bold",
  "scarlet-vanilla": "food-bold",
  "crimson-custard": "food-bold",
  "ember-clementine": "food-bold",
  "garnet-biscuit": "food-bold",
};
