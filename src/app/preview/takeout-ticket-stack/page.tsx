...
import { sampleTemplateDataTakeoutTicketStack } from "@/lib/templates/sampleData";

export default function TakeoutTicketStackPreviewPage() {
  const previews = [
    sampleTemplateDataTakeoutTicketStack,
    {
      ...
      itemNumber: 16,
      title: "Fresh Taco Dinner Recipes",
      subtitle: "Hot Order",
    },
    {
      ...sampleTemplateDataTakeoutTicketStack,
      ...
      itemNumber: 22,
      title: "Summer Party Dip Ideas",
      subtitle: "Pickup Favorites",
    },
    {
      ...sampleTemplateDataTakeoutTicketStack,
      visualPreset: "midnight-gold",
      itemNumber: 14,
      title: "Cozy Soup Dinner Recipes",
      ...
      <div className="mx-auto flex max-w-none flex-col gap-6">
        <div>
          ...
          <p className="mt-3 max-w-3xl text-base leading-7 text-[#614734]">
            A loud receipt-and-order-ticket food roundup layout with a hero image inside a printed
            ticket slab, a docked count tab, and staggered support tickets below.
          </p>
        </div>
          ...
          <div className="grid gap-6 xl:grid-cols-2 2xl:grid-cols-3">
            {previews.map((preview, index) => (
              ...
              >
                ...
                >
                  {renderTemplate("takeout-ticket-stack", preview)}
                </ResponsiveCanvasPreview>
              </div>
            ))}
          </div>
