...
import { sampleTemplateDataFourImageMasonryHeroNumberDomainPill } from "@/lib/templates/sampleData";

export default function FourImageMasonryHeroNumberDomainPillPreviewPage() {
  return (
      ...
      <div className="mx-auto flex max-w-[1560px] flex-col gap-6">
        <div>
          ...
          <h1 className="mt-2 text-4xl font-black uppercase tracking-[-0.05em] text-[#2d1a0e]">
            Four Image Number Title Sitename
          </h1>
        </div>
