...
import { sampleTemplateDataFourImageGridTitleFooter } from "@/lib/templates/sampleData";

export default function FourImageGridTitleFooterPreviewPage() {
  return (
    <main className="min-h-screen bg-[#e8dfd0] px-6 py-8">
      <div className="mx-auto flex max-w-[1560px] flex-col gap-6">
        ...
        <div className="overflow-auto rounded-[36px] bg-white p-6 shadow-[0_28px_70px_rgba(58,39,14,0.12)]">
          {renderTemplate("four-image-grid-title-footer", sampleTemplateDataFourImageGridTitleFooter)}
        </div>
      </div>
    </main>
  );
