...
import { sampleTemplateDataWithSubtitle } from "@/lib/templates/sampleData";

export default function SplitVerticalTitlePreviewPage() {
  return (
      ...
      <div className="mx-auto flex max-w-[1560px] flex-col gap-6">
        <div>
          ...
          <h1 className="mt-2 text-4xl font-black uppercase tracking-[-0.05em] text-[#23160d]">
            Split Vertical Title With Subtitle
          </h1>
        </div>
        <div className="overflow-auto rounded-[36px] bg-white p-6 shadow-[0_28px_70px_rgba(58,39,14,0.12)]">
          {renderTemplate("split-vertical-title", sampleTemplateDataWithSubtitle)}
        </div>
      </div>
    </main>
  );
